...
class WienerFilter:
    ...
    def demonstrate_restoration(self, image_path: str):
        ...
        for kernel_name, kernel in kernels.items():
            ...
            self.test_butterworth_enhancement(img, kernel, noise_variances[1])
    ...
    def test_butterworth_enhancement(self, img: np.ndarray, kernel: np.ndarray,
        ...
        fig.suptitle('Wiener Filter with Butterworth Enhancement', fontsize=14)
        ...
        axes[2].set_title('Wiener (no Butterworth)')
        axes[2].axis('off')
        ...
        axes[3].set_title('Wiener + Butterworth')
        axes[3].axis('off')

        plt.tight_layout()
        plt.show()

    def create_synthetic_image(self, size: Tuple[int, int] = (256, 256)) -> np.ndarray:
        """
